...
<fileswitch> exported  = ("switch file to") {switchapp};
    ...
    def initialize(self):
        ...
        self.taskdocCounts = list(range(1, self.maxTaskDocNumber+1))
        ...
        self.iconCounts = list(range(1, self.maxIconNumber+1))  # int or str both work
        ...
        self.setList('direction', list(self.directions.keys()))
        self.activateAll()
