...
baseDirectory = uniutils.getUnimacroUserDirectory()
    ...
    def gotResultsObject(self,recogType,resObj):
        if self.doMessages:
            ...
            if mes:
                ...
                return
            uniutils.doPendingBringUps()  # if there were
